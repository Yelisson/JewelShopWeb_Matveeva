...
namespace JewelShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IElementService, ElementServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<ICustomerService, CustomerServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IAdornmentService, AdornmentServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IHangarService, HangarServiceDB>(new HierarchicalLifetimeManager());
